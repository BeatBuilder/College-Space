...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2022 at 12:34 PM
...
(1, 'Admin', 'admin', 9328684240, 'admin@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2022-02-11 23:06:52');
...
(1, '10', 'A', '2022-02-13 05:12:14'),
(2, '10', 'B', '2022-02-13 05:12:35'),
(3, '10', 'C', '2022-02-13 05:12:41'),
(4, '11', 'A', '2022-02-13 05:12:47'),
(5, '11', 'B', '2022-02-13 05:12:52'),
(6, '11', 'C', '2022-02-13 05:12:57'),
(7, '11', 'D', '2022-02-13 05:13:04'),
(8, '12', 'A', '2022-02-13 05:13:10'),
(9, '12', 'C', '2022-02-13 05:13:15');
...
CREATE TABLE `tblhod` (
  `ID` int(10) NOT NULL,
  `HODName` varchar(120) DEFAULT NULL,
  `UserName` varchar(120) DEFAULT NULL,
  `MobileNumber` bigint(10) DEFAULT NULL,
  `Email` varchar(200) DEFAULT NULL,
  `Password` varchar(200) DEFAULT NULL,
...
INSERT INTO `tblhod` (`ID`, `HODName`, `UserName`, `MobileNumber`, `Email`, `Password`, `Regdate`) VALUES
(1, 'HOD', 'HOD', 1234567890, 'hod@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2022-02-11 23:06:52');
...
(2, 'Marks of Unit Test.', 3, 'Meet your class teacher for seeing copies of unit test', '2022-02-19 01:05:58'),
(3, 'Marks of Unit Test.', 2, 'Meet your class teacher for seeing copies of unit test', '2022-02-19 01:05:58'),
(4, 'Test', 3, 'This is for testing.', '2022-02-02 12:47:03'),
(5, 'Test Notice', 8, 'This is for Testing.', '2022-02-02 13:33:43');
...
(2, 'contactus', 'Contact Us', 'Dis-Panchmahal, Gujarat, 389341', 'admin@gmail.com', 9328684240, NULL);
...
(1, 'School will re-open', 'Consult your class teacher.', '2022-01-20 03:41:57'),
