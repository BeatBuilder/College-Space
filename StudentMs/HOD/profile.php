...
if (strlen($_SESSION['sturecmsaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $HODName=$_POST['adminname'];
  $mobno=$_POST['mobilenumber'];
  $email=$_POST['email'];
  $sql="update tblhod set HODName=:adminname,MobileNumber=:mobilenumber,Email=:email where ID=:aid";
     $query = $dbh->prepare($sql);
     $query->bindParam(':adminname',$HODName,PDO::PARAM_STR);
...
<html lang="en">
  <head>
    ...
    <title> College Space|| Profile</title>
    <!-- plugins:css -->
...
{               ?>
                      <div class="form-group">
                        <label for="exampleInputName1">HOD Name</label>
                        <input type="text" name="adminname" value="<?php  echo $row->HODName;?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
