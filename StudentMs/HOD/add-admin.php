...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $ret="select UserName from tbladmin where UserName=:uname || ID=:stuid";
...
$sql="insert into tbladmin(AdminName,AdminEmail,Gender,DOB,AdminID,ContactNumber,AltenateNumber,Address,UserName,Password,Image)values(:stuname,:stuemail,:gender,:dob,:stuid,:connum,:altconnum,:address,:uname,:password,:image)";
...
<html lang="en">
  <head>
    ...
    <title>College Space || Add Students</title>
    <!-- plugins:css -->
